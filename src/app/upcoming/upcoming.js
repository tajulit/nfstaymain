            ...
            <div className="pb-2.5 pt-6 flex flex-col gap-6 xl:pb-1">
                <div className="flex items-center justify-between gap-5">
                    <div className="flex gap-2 flex-col justify-between">
                        ...
                        <p className="opacity-80 text-[#0C0839] 2xl:text-lg">Mint exclusive Real Estate NFTs before they hit the secondary market</p>
                    </div>
                </div>
                {/* <div className="flex items-center flex-wrap gap-5">
                    ...
                    <button className="border-none outline-none text-[#954AFC] font-medium 2xl:text-lg">Clear all filters</button>
                </div> */}
