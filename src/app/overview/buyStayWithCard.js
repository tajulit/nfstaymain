...
const BuyStayWithCard = () => {
    ...
    return (
        <div className="flex flex-col gap-4 p-4 rounded-lg shadow border">
            <h1 className="font-bold text-xl 2xl:text-3xl">Buy STAY with CARD</h1>
            ...
            <button type="button" className="w-full rounded-lg bg-[#954AFC] py-2 px-4 text-center text-white my-2 2xl:text-lg font-medium">Buy with Fiat</button>
        </div>
    );
};
