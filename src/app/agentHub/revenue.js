            ...
            <div className="flex flex-col w-full gap-3">
                <div className="flex flex-col md:flex-row gap-7 items-center justify-between">
                    <div className="flex flex-col w-full sm:w-fit  gap-3">
                        <h1 className="font-semibold text-sm text-[#0C0839] opacity-80 2xl:text-xl">Monthly Revenue</h1>
                        <div className="flex gap-2">
                            <h2 className="font-bold text-3xl 2xl:text-4xl">$5,800</h2>
                            <span className="px-4 py-1.5 rounded-full text-[#27AE60] bg-[#6FCF971A] font-medium 2xl:text-base">+10.6%</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-8 flex-wrap">
                        {
                            filters.map((filter, index) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded text-sm font-medium 2xl:text-base ${currentFilter === filter ? "bg-[#954AFC] text-white" : "text-black bg-white"} transition-all`}>
                                    {filter}
                                </button>
                            ))
                        }
